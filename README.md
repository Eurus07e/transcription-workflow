# WELearn Theme 2 Transcription Workflow

智汇大学英语听说教程 4 / Theme 2 的视频转写、中文校对翻译和中英对照 LaTeX/PDF 输出。

这个仓库只保存有复用价值的内容：最终文稿、LaTeX 源文件、原始转写文本和转录/排版脚本。课程视频、音频、模型缓存和构建缓存不纳入 Git。
